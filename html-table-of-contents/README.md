...
|                 Status                  | Check                                                                                    |
| :-------------------------------------: | :--------------------------------------------------------------------------------------- |
| ![Status](../../blob/badges/.github/badges/main/status0.svg) | Each heading should have a unique ID |

### Table of contents

|                 Status                  | Check                                                                                    |
| :-------------------------------------: | :--------------------------------------------------------------------------------------- |
| ![Status](../../blob/badges/.github/badges/main/status1.svg) | Table of contents should be wrapped with an outer **ordered list** tag |

### Anchors

|                 Status                  | Check                                                                                    |
| :-------------------------------------: | :--------------------------------------------------------------------------------------- |
| ![Status](../../blob/badges/.github/badges/main/status2.svg) | Anchor links should scroll to the corresponding heading |
| ![Status](../../blob/badges/.github/badges/main/status3.svg) | 'Back to top' Link should scroll page to the top |
